...
namespace EF.Dal.EfStructures.Migrations
{
    ...
    [Migration("20211025074806_UpdatedEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EF.Models.Entities.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EF.Models.Entities.SeriLogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EF.Models.Entities.ViewModels.CustomerOrderViewModel", b =>
                {
                    b.Property<string>("Color")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EF.Models.Entities.Car", b =>
                {
                    b.HasOne("EF.Models.Entities.Make", "MakeNavigation")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("EF.Models.Entities.CreditRisk", b =>
                {
                    b.HasOne("EF.Models.Entities.Customer", "CustomerNavigation")
                    ...
                    b.OwnsOne("EF.Models.Entities.Owned.Person", "PersonalInformation", b1 =>
                        {
            ...
            modelBuilder.Entity("EF.Models.Entities.Order", b =>
                {
                    b.HasOne("EF.Models.Entities.Car", "CarNavigation")
                        .WithMany("Orders")
                        .HasForeignKey("CarId")
