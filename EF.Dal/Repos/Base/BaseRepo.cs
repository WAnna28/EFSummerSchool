...
{
    // The BaseRepo class will implement the IRepo interface and provide the core functionality for type-specific repos.

    // The repo needs an instance of the ApplicationDbContext injected into a constructor. When used with
    // the ASP.NET Core DI container, the container will handle the lifetime of the context.A second constructor
    // will accept DbContextOptions and need to create an instance of the ApplicationDbContext.That context
    // will need to be disposed.Because this class is abstract, both constructors are protected. Add
